...
levvy = User.create(email: 'levvy@t.t', visible_name: 'Levvy', password: '1234', permission_level: 4)
...
User.create(email: 'banheld@wp.pl', visible_name: 'Adam Mikołajczyk', password: '1234') #Do testów
