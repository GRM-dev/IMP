...
ActiveRecord::Schema.define(version: 20160605191956) do
  ...
  create_table "dashboard_assignments", force: :cascade do |t|
    t.integer  "dashboard_id",              limit: 4,   null: false
    t.integer  "dashboard_permission_id",   limit: 4,   null: false
    t.integer  "dashboard_role_id",         limit: 4,   null: false
    t.integer  "assignable_id",             limit: 4,   null: false
    t.string   "assignable_type",           limit: 255, null: false
    t.integer  "dashboard_user_setting_id", limit: 4
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
  end

  add_index "dashboard_assignments", ["assignable_type", "assignable_id"], name: "index_dashboard_assignments_on_assignable_type_and_assignable_id", using: :btree
  add_index "dashboard_assignments", ["dashboard_id"], name: "index_dashboard_assignments_on_dashboard_id", using: :btree
  add_index "dashboard_assignments", ["dashboard_permission_id"], name: "index_dashboard_assignments_on_dashboard_permission_id", using: :btree
  add_index "dashboard_assignments", ["dashboard_role_id"], name: "index_dashboard_assignments_on_dashboard_role_id", using: :btree

  create_table "dashboard_permissions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "laboratories_assignments", force: :cascade do |t|
    ...
    t.integer  "dashboard_permission_id", limit: 4,   null: false
    t.integer  "lab_assignable_id",       limit: 4,   null: false
    t.string   "lab_assignable_type",     limit: 255, null: false
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  end

  add_index "laboratories_assignments", ["lab_assignable_type", "lab_assignable_id"], name: "index_lab_assignments", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "last_login",                  default: '2016-07-10 19:35:28', null: false
    t.string   "last_ip",         limit: 255, default: "0.0.0.0",             null: false
    t.boolean  "was_activated",               default: false,                 null: false
    t.boolean  "active",                      default: true,                  null: false
    t.datetime "last_seen",                   default: '2016-07-10 19:35:28', null: false
  ...
  add_foreign_key "dashboard_assignments", "dashboard_permissions"
